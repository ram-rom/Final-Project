 ...
 *
 *  BPredPerc:  a predictor that uses perceptrons and training.
 *
 *    This predictor has a table of perceptrons where each perceptron
 *    is an array of weights. The predictor predicts taken if the output
 *    of the dot product of the perceptron with the global shift registry
 *    is greater than 0 and not taken otherwise.
 *
 *
